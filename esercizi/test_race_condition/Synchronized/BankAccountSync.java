...
public class BankAccountSync {
  ...
  public BankAccountSync(int amount) {
    setAmount(amount);
    this.id = ++lastId;
  }
  ...
  public boolean equals(Object obj) {
    ...
    BankAccountSync other = (BankAccountSync) obj;
   ...
   */
  public synchronized int tryWithdraw(int withdrawRequest) {  // just one subtle change
